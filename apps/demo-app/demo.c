...
static bool my_input_callback(InputEvent* input_event, void* context) {
    FURI_LOG_D("demo", "my_input_callback()");
...
bool view_dispatcher_navigation_event_callback(void* context) {
    FURI_LOG_D("demo", "view_dispatcher_navigation_event_callback()");
...
bool my_view_dispatcher_custom_event_callback(void* context, uint32_t event) {
    FURI_LOG_D("demo", "my_view_dispatcher_custom_event_callback()");
...
void variable_item_list_item_change_callback(VariableItem* item) {
    FURI_LOG_D("demo", "variable_item_list_item_change_callback()");
    switch(variable_item_get_current_value_index(item)) {
    case 0:
        variable_item_set_current_value_text(item, "Up");
        break;
    case 1:
        variable_item_set_current_value_text(item, "Left");
        break;
    case 2:
        variable_item_set_current_value_text(item, "Ok");
        break;
    case 3:
        variable_item_set_current_value_text(item, "Right");
        break;
    case 4:
        variable_item_set_current_value_text(item, "Down");
        break;
    default:
        variable_item_set_current_value_text(item, "empty");
        break;
    }
}
...
int32_t demo_app() {
    ...
    View* view2 = variable_item_list_get_view(variable_item_list);
    ...
    variable_item_list_add(
        variable_item_list, "Option 1", 2, variable_item_list_item_change_callback, my_context);

    variable_item_list_add(
        variable_item_list, "Option 2", 3, variable_item_list_item_change_callback, my_context);

    variable_item_list_add(
        variable_item_list, "Option 3", 6, variable_item_list_item_change_callback, my_context);

    variable_item_list_set_selected_item(variable_item_list, 0xF);
